...
class Trading_Agent:
    def __init__(self, data, initial_funds=1000000, transaction_cost=0.01):
        self.data = data
    ...
    def simulate_trades(self, actions):
        ...
        funds_over_time.to_csv('JPM_capital.csv')
        ...
        metrics_df.to_csv('JPM_result.csv')
